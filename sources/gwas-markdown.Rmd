...
The following table shows the SNPs in Linkage Disequilibrium above $R^2$ = `r R2`

```{r SNPsLDTable,  echo=FALSE, message=FALSE}
SNPsLDTable = read.csv (file=paste0(inputDir, "/out-multiGWAS-SNPsLDTable.csv"))
kable (SNPsLDTable) %>%
 	kable_styling(bootstrap_options = c("striped", "hover", "condensed", font_size=5))
```
